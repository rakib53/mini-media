  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <h2 className="w-max py-3 px-5 rounded-2xl bg-blue-600 text-white text-center font-Asap text-xl leading-[150%] font-bold">
          Q
        </h2>
      </div>
      <div className="w-full min-h-full flex flex-col gap-9 mt-12">
